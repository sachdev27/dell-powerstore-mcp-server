"""Logging configuration for PowerStore MCP Server.
...
Example:
    >>> from powerstore_mcp.logging_config import setup_logging, get_logger
...
def setup_logging(
    ...
    """Configure logging for the PowerStore MCP Server.
    ...
    Example:
        ...
        >>> logger = logging.getLogger("powerstore_mcp")
...
class LoggerAdapter(logging.LoggerAdapter):
    ...
    Example:
        ...
        >>> adapter.info("Request sent", extra={"url": "/volumes"})
    """
